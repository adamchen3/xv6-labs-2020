...
KERNEL_FILES = kernel/defs.h kernel/printf.c kernel/sysproc.c kernel/riscv.h kernel/syscall.h kernel/syscall.c kernel/sysproc.c kernel/proc.h kernel/proc.c kernel/trap.c
