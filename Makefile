...
USER_FILES = user/user.h user/usys.pl user/usertests.c user/init.c
KERNEL_FILES = kernel/defs.h kernel/vm.c kernel/exec.c kernel/proc.h kernel/proc.c kernel/trap.c
